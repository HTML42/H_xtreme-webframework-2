...
//Minified PHP-File from here: https://raw.githubusercontent.com/PHPMailer/PHPMailer/master/src/PHPMailer.php
...
class PHPMailer {
    ...
    public static function validateAddress($address, $patternselect = null) {
        if (null === $patternselect) {
            ...
            case 'php':default:return (bool) filter_var($address, FILTER_VALIDATE_EMAIL);
        }
    }
